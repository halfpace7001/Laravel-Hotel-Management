...
@section('content')
    ...
    <div class="container mt-5 mb-3">
        <div class="row d-flex justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="d-flex flex-row p-2 "> <img src="{{ asset('img/logo/Taj_Hotels_logo.png') }}" width="48">
                        <div class="d-flex flex-column" style="margin-left: 20px"> <span
                                class="font-weight-bold">Invoice</span>
